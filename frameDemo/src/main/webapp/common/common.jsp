...
<link rel="stylesheet" type="text/css" href="${ctx}/css/showLoading/showLoading.css"/>
<link rel="stylesheet" type="text/css" href="${ctx}/css/jquery.webui-popover.min.css"/>
...
<script type="text/javascript" src="${ctx}/script/jquery.showLoading.min.js"></script>
<script type="text/javascript" src="${ctx}/script/jquery.jqGrid.min.js"></script>
