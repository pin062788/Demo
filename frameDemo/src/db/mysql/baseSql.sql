/*
MySQL Data Transfer
Source Host: 10.112.4.155
Source Database: ansola
Target Host: 10.112.4.155
Target Database: ansola
Date: 2016/7/13 ������ 15:26:35
*/
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_configure_resource`;
CREATE TABLE `tb_configure_resource` (
  `configure_resource_id` char(32) COLLATE utf8_bin DEFAULT NULL,
  `configure_resource_name` varchar(20) COLLATE utf8_bin NOT NULL,
  `configure_resource_url` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_group_user_role_mapping`;
CREATE TABLE `tb_group_user_role_mapping` (
  `id` char(32) COLLATE utf8_bin DEFAULT NULL,
  `releated_type` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `releated_id` char(32) COLLATE utf8_bin DEFAULT NULL,
  `edit_date` date DEFAULT NULL,
  `edit_user` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `role_id` char(32) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tb_organization` (
  ...
  `parent_org_id` char(32) COLLATE utf8_bin DEFAULT NULL,
  `org_code` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `org_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `org_type` char(1) COLLATE utf8_bin DEFAULT NULL,
  `org_address` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `org_funtype_code` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  `org_order` varchar(8) COLLATE utf8_bin DEFAULT NULL,
  `expire` char(1) COLLATE utf8_bin DEFAULT NULL,
  `expire_date` date DEFAULT NULL,
  `add_user` char(32) COLLATE utf8_bin DEFAULT NULL,
  `add_date` date DEFAULT NULL,
  `edit_user` char(32) COLLATE utf8_bin DEFAULT NULL,
  `edit_date` date DEFAULT NULL,
  `org_desc` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `scbj` char(1) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`org_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tb_permission` (
  `permission_id` char(32) COLLATE utf8_bin NOT NULL,
  `role_code` char(32) COLLATE utf8_bin DEFAULT NULL,
  `resource_code` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `permission_type` char(1) COLLATE utf8_bin DEFAULT NULL,
  `remark` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `edit_date` date DEFAULT NULL,
  `edit_user` char(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `tb_reference` (
  ...
  `code_desc` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `is_parent` char(1) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `tb_resource` (
  `resource_id` char(32) COLLATE utf8_bin NOT NULL,
  `resource_code` varchar(32) COLLATE utf8_bin NOT NULL,
  `parent_resource_code` varchar(32) COLLATE utf8_bin NOT NULL,
  `resource_name` varchar(20) COLLATE utf8_bin NOT NULL,
  `resource_desc` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `resource_url` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `resource_type` char(2) COLLATE utf8_bin NOT NULL,
  `edit_date` date DEFAULT NULL,
  `edit_user` char(32) COLLATE utf8_bin DEFAULT NULL,
  `order_number` int(10) DEFAULT NULL,
  `resource_sn` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `active_module` char(1) COLLATE utf8_bin DEFAULT NULL,
  `parent_module_code` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `resource_img` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_restrict`;
CREATE TABLE `tb_restrict` (
  `restrict_id` char(32) COLLATE utf8_bin NOT NULL,
  `role_id` char(32) COLLATE utf8_bin NOT NULL,
  `table_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `column_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `column_type` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `opt_code` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `conn_code` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `restrict_value` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `order_number` varchar(500) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_restrict_column`;
CREATE TABLE `tb_restrict_column` (
  `column_id` char(32) COLLATE utf8_bin NOT NULL,
  `table_id` char(32) COLLATE utf8_bin NOT NULL,
  `column_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `column_desc` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `column_type` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `data_source` varchar(500) COLLATE utf8_bin DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `tb_restrict_table`;
CREATE TABLE `tb_restrict_table` (
  `table_id` char(32) COLLATE utf8_bin NOT NULL,
  `table_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `table_desc` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `tb_role` (
  ...
  `edit_date` date DEFAULT NULL,
  `edit_user` char(32) COLLATE utf8_bin DEFAULT NULL,
  `role_code` varchar(16) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tb_sequence` (
  ...
  `MAX_VALUE` int(11) NOT NULL DEFAULT '2147483647',
...
CREATE TABLE `tb_user` (
  ...
  `edit_date` date DEFAULT NULL,
  `edit_user` char(32) COLLATE utf8_bin DEFAULT NULL,
  `related_type` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `related_id` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `employee_id` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `user_related_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `configure` varchar(2000) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `tb_employee` (
  ...
  `EMPLOYEE_BH` varchar(32) DEFAULT NULL COMMENT '人员编号',
  `EMPLOYEE_MC` varchar(32) DEFAULT NULL COMMENT '人员名称',
  `EMPLOYEE_ZZBM` varchar(32) DEFAULT NULL COMMENT '组织部门编码',
  `EMPLOYEE_ZZBMMC` varchar(32) DEFAULT NULL COMMENT '组织部门名称',
  `EMPLOYEE_ZZBMID` varchar(32) DEFAULT NULL COMMENT '组织部门ID',
  `EMPLOYEE_ZW` varchar(32) DEFAULT NULL COMMENT '职位',
  `EMPLOYEE_XB` char(1) DEFAULT NULL COMMENT '性别:1男2女',
  `EMPLOYEE_SJH` varchar(32) DEFAULT NULL COMMENT '手机号',
  `EMPLOYEE_BZ` varchar(200) DEFAULT NULL COMMENT '备注',
  `ADD_USER` varchar(32) DEFAULT NULL COMMENT '添加人',
  `ADD_DATE` datetime DEFAULT NULL COMMENT '添加日期',
  `EDIT_USER` varchar(32) DEFAULT NULL COMMENT '修改人',
  `EDIT_DATE` datetime DEFAULT NULL COMMENT '修改日期',
  `ACTIVATE` char(1) DEFAULT NULL COMMENT '是否有效:1可用0失效',
...
INSERT INTO `tb_reference` VALUES ('74CD2978BF404A9581EB7EABD9D72C7A', '7B40926D94064CA59FFB8049628DD44D', '1', '单位',
                                   '0', null, '1', null, 'admin', '0');
...
INSERT INTO `tb_reference` VALUES ('FEC46B53B41B4641A78773DDF67B73D5', 'CABEE603042644C58587BA12C180434D', '2',
                                   '储运公司', '0', null, '1', null, 'admin', '0');
...
INSERT INTO `tb_reference` VALUES ('0DF7425D5BF04F589B6BB228DD30D8C5', '7B40926D94064CA59FFB8049628DD44D', '2', '部门',
                                   '0', null, '1', null, 'admin', '0');
INSERT INTO `tb_reference` VALUES ('1B08ADC09B5F444D9DB2259D18B9E5D9', '7B40926D94064CA59FFB8049628DD44D', '0', '集团',
                                   '0', null, '1', null, 'admin', '0');
