    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#addRestrictColumnBtn").button({
                ...
                openDialog("columnDetailDialog", _url, "过滤字段 ->增加");
            });
            $("#modifyRestrictColumnBtn").button({
                ...
                openDialog("columnDetailDialog", _url, "过滤字段 ->修改");
            });
                ...
                if (rowData.length > 0) {
                    if (confirm("确认删除数据吗？")) {
                        ...
                        $.postAjax (url, null, null, function (data) {
                            ...
                            if (result.status == '1') {
                                alert("删除成功");
                                closeAndReload("", "restrictColumns");
                            } else {
            ...
            initDialog("columnDetailDialog", "表添加", true, 700, 350);
        });
        function afterSave() {
