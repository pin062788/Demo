    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#findRestrictTableBtn").button({
                ...
                if (haveSpecialCharacter(tableName)) {
                    $("#error").html("<font color='red'>表名不能包含特殊字符，请重新输入！</font>");
                } else {
                    $("#error").html("");
            ...
            $("#addRestrictTableBtn").button({
                ...
                openDialog("tableDetailDialog", _url, "表管理 ->增加");
            });
            $("#modifyRestrictTableBtn").button({
                ...
                openDialog("tableDetailDialog", _url, "表管理 ->修改");
            });
            ...
            initDialog("tableDetailDialog", "表添加", true, 700, 150);
        });
