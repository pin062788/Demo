    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#findUserBtn").button({
                ...
                if (haveSpecialCharacter(userName)) {
                    $("#error").html("<font color='red'>用户名不能包含特殊字符，请重新输入！</font>");
                } else if (haveSpecialCharacter(rName)) {
                    $("#error").html("<font color='red'>名称不能包含特殊字符，请重新输入！</font>");
                } else {
                    $("#error").html("");
            ...
            $("#addUserBtn").button({
                ...
                openDialog("detailDialog", _url, "用户管理 ->增加");
            });
            ...
            initDialog("detailDialog", "用户添加", true, 800, 400);
        });
        function afterSave() {
