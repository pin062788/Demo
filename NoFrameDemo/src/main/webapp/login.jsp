...
<head>
    ...
    <link rel="stylesheet" class="system-theme" type="text/css"
          href="${pageContext.request.contextPath}/theme/system/default/css/imep.css"/>
    ...
    <script type="text/javascript">
        ...
        function verify() {
            ...
            if (haveSpecialCharacter(userName) || haveSpecialCharacter(password)) {
...
<div class="login_main">
            ...
            <table class="login_left_table1">
                <tr class="login_left_tr">
                    <td class="login_info_select login_info_select_active" property="">
                        <img alt="" src="${pageContext.request.contextPath}/theme/system/default/images/login/default.png">
                    </td>
    ...
    <div class="login_right">
        <img alt="" src="${pageContext.request.contextPath}/theme/system/default/images/login/right.png">
    </div>
</div>
</body>
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/jquery.showLoading.min.js"></script>
